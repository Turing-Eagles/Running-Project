...
<body>
  <div id="main">
    ...
    <div id="slideshow_container">  
	  <div class="slideshow">
	    <ul class="slideshow">
          <li class="show"><img width="940" height="250" src="images/home_1.jpg" alt="&quot;Follow your dreams&quot;" /></li>
          <li><img width="940" height="250" src="images/home_2.jpg" alt="&quot;Be yourself&quot;" /></li>
        </ul> 
	  </div><!--close slideshow-->  	
	  ...
	  <div class="sidebar_container">       
		<div class="sidebar">
          <div class="sidebar_item">
            ...
            <p>In this tab, you can create an account so that you can start registering for races!</p>
          </div><!--close sidebar_item--> 
        </div><!--close sidebar-->     		
		<div class="sidebar">
          <div class="sidebar_item">
            <h3>Account information</h3>
            <p>We ask for some details about you so that other racers can see what they're up against when they register for a race.</p>         
		  </div><!--close sidebar_item--> 
        </div><!--close sidebar-->
				...
				<table border="0">
				  <tr>
					<td>Change Password</td>
					 <td><input type="password" name="password" maxlength="15" size="30"
					 ></td>
				  </tr>
				  <tr>
					<td>Re-enter Password</td>
					 <td><input type="password" name="password2" maxlength="15" size="30"
					 ></td>
				  </tr>
				  <tr>
